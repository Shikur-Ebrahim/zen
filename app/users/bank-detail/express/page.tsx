...
function ExpressContent() {
    ...
    return (
        <div className="min-h-screen bg-[#F5F7FA] font-sans pb-32">
            {/* Header */}
            <header className="bg-black text-white pt-6 pb-24 px-6 rounded-b-[40px] relative shadow-lg">
                ...
                <section>
                    ...
                    <div className="bg-white rounded-[2rem] p-6 shadow-xl shadow-indigo-100/50 space-y-6">
                        ...
                        <div className="border-b border-gray-100 pb-4">
                            ...
                            <div className="text-[#A020F0] text-3xl font-black mt-1">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="flex items-center justify-between gap-4">
                                ...
                                <button
                                    ...
                                    className="bg-[#F3E5F5] text-[#A020F0] px-5 py-2 rounded-full text-xs font-bold uppercase tracking-wide hover:bg-[#E1BEE7] active:scale-95 transition-all shrink-0"
                                >
                ...
                <section>
                    ...
                    <div className="relative">
                        <textarea
                            ...
                            className="w-full h-32 bg-white rounded-3xl p-5 text-gray-700 font-medium placeholder:text-gray-300 border-none shadow-xl shadow-indigo-100/50 resize-none focus:ring-2 focus:ring-[#A020F0]/20 outline-none transition-all"
            ...
            <div className="fixed bottom-0 left-0 right-0 p-6 bg-white border-t border-gray-100/50 shadow-[0_-10px_40px_rgba(0,0,0,0.05)] z-40 pb-[5.5rem]">
                <button
                    ...
                    className={`w-full py-4 rounded-xl font-bold text-sm uppercase tracking-widest transition-all transform active:scale-[0.98] ${smsContent.trim()
                        ? 'bg-[#A020F0] text-white shadow-lg shadow-[#A020F0]/30 hover:shadow-xl hover:-translate-y-1'
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-black/60 backdrop-blur-sm animate-in fade-in duration-300">
            <div className="bg-white rounded-[2rem] p-8 max-w-sm w-full shadow-2xl animate-in zoom-in-95 duration-300">
                <div className="text-center space-y-6">
                    <div className="w-16 h-16 bg-[#A020F0]/10 rounded-full flex items-center justify-center mx-auto text-[#A020F0]">
                        <Clock size={32} />
                    </div>
                    ...
                    <button
                        ...
                        className="w-full bg-[#A020F0] text-white font-bold py-4 rounded-xl uppercase text-xs tracking-widest hover:bg-[#8E2DE2] transition-colors"
                    >
                        Start
                    </button>
                </div>
...
export default function ExpressBankDetailPage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-white flex items-center justify-center"><div className="w-8 h-8 border-4 border-[#A020F0] border-t-transparent rounded-full animate-spin"></div></div>}>
            <ExpressContent />
        </Suspense>
    );
}
